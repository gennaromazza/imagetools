export type DesktopToolId = "suite-launcher" | "image-party-frame" | "batch-print-layout" | "archivio-flow" | "image-converter" | "image-file-finder" | "cache-sweep" | "photo-selector-app";
