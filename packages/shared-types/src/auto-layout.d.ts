...
export interface UpdatePageSheetSpecRequest {
    pageId: string;
    changes: Partial<Pick<SheetSpec, "presetId" | "label" | "widthCm" | "heightCm" | "dpi" | "marginCm" | "gapCm" | "bleedCm" | "backgroundColor" | "backgroundImageUrl" | "photoBorderColor" | "photoBorderWidthCm" | "showRulers" | "rulerUnit" | "verticalGuidesCm" | "horizontalGuidesCm">>;
}
