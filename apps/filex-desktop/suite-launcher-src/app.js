...
const metadata = {
  ...
  'filex-send': { icon:'suite', category:'Consegna', description:'Riceve foto e video dal telefono del cliente direttamente sul PC tramite la rete Wi-Fi del negozio. Il cliente scansiona un QR, sceglie i file e li invia senza account, app o servizi cloud.', color:'#39c9a5' },
};
