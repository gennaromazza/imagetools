...
const metadata = {
  ...
  'id-photo': { icon:'print', category:'Stampa', description:'Prepara fototessere per documenti con profili versionati, controlli tecnici locali, passaggio su copia di lavoro in Photoshop e impaginazione automatica 10×15 o 15×20 pronta per il laboratorio.', color:'#b89a63' },
