...
const api: FileXDesktopApi = {
  ...
  showArchivioFlowWindow: () => ipcRenderer.invoke("filex:show-archivio-flow-window"),
  ...
  reconcileArchivioIndex: () => ipcRenderer.invoke("filex:reconcile-archivio-index"),
  resumeArchivioImport: (sessionId) => ipcRenderer.invoke("filex:resume-archivio-import", sessionId),
  syncArchivioDriveRegistry: () => ipcRenderer.invoke("filex:sync-archivio-drive-registry"),
  ...
  getArchivioStartAtLogin: () => ipcRenderer.invoke("filex:get-archivio-start-at-login"),
  setArchivioStartAtLogin: (enabled) => ipcRenderer.invoke("filex:set-archivio-start-at-login", enabled),
  ...
  getArchivioArchiveRenameProgress: () => ipcRenderer.invoke("filex:get-archivio-archive-rename-progress"),
