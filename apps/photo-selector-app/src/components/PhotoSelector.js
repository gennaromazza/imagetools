                            ...
                            height: dragRect.height,
                                    ...
                                    : sourceFolderPath
                                        ...
                                        : selectedThumbnailProfile === "fast"
                                            ...
                                            return (_jsxs("button", { type: "button", className: `ghost-button ghost-button--small${isActive ? " ghost-button--active" : ""}`, onClick: () => void onRamBudgetPresetChange(preset), title: `${label}: ${gb} GB (${Math.round(fraction * 100)}% RAM)`, children: [label, " (", gb, " GB)"] }, preset));
                                        }) }), _jsx("p", { className: "photo-selector__settings-empty", style: { marginTop: "0.3rem" }, children: desktopThumbnailCacheInfo.ramBudgetPreset
