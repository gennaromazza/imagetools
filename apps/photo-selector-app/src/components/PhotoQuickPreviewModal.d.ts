...
export declare function PhotoQuickPreviewModal({ asset, assets, thumbnailProfile, startZoomed, usageByAssetId, pages, activePageId, customLabelsCatalog, customLabelColors, customLabelShortcuts, onClose, onSelectAsset, onAddToPage, onJumpToPage, onUpdateAsset }: PhotoQuickPreviewModalProps): import("react/jsx-runtime").JSX.Element | null;
export {};
